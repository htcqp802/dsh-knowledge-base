	...
	factory: (require) => {
		...
		*/
		...
		function KnowledgePanel(_props) {
			...
			const [importingLabel, setImportingLabel] = (0, react.useState)("导入中…");
			...
			const [viewMode, setViewMode] = (0, react.useState)("dir");
			const [files, setFiles] = (0, react.useState)([]);
			const [fileFilter, setFileFilter] = (0, react.useState)("");
			const [fileCategory, setFileCategory] = (0, react.useState)("");
			const [classifying, setClassifying] = (0, react.useState)(false);
			const [suggestions, setSuggestions] = (0, react.useState)(null);
			const [accepted, setAccepted] = (0, react.useState)(/* @__PURE__ */ new Set());
			...
			const importFile = (0, react.useCallback)(async (file) => {
				...
				return await postJson("/api/kb/import", {
					name: file.name,
					contentBase64
				});
			}, []);
			...
			const importFiles = (0, react.useCallback)(async (files) => {
				...
				await refresh();
				if (failed > 0) window.alert(`导入完成：成功 ${total - failed}/${total}，失败 ${failed} 个文件`);
			}, [importFile, refresh]);
			/** 加载全部文件清单。 */
			const loadFiles = (0, react.useCallback)(async () => {
				try {
			...
			/** 触发 AI 整理：对未分类文件生成建议。 */
			const runClassify = (0, react.useCallback)(async () => {
				setClassifying(true);
				setSuggestions(null);
				...
				try {
					...
					setAccepted(new Set(data.suggestions.map((_, i) => i).filter((i) => data.suggestions[i]?.error === void 0)));
				} catch (error) {
			...
			/** 采纳建议：对选中的文件应用分类/改名。 */
			const applySuggestions = (0, react.useCallback)(async () => {
				if (suggestions === null) return;
				let ok = 0;
				let failed = 0;
				for (const i of accepted) {
					const s = suggestions[i];
					if (s === void 0 || s.error !== void 0) continue;
					try {
						const current = files.find((f) => f.source === s.source);
						if (current !== void 0 && s.category !== void 0 && s.category !== "" && s.category !== current.category) await postJson("/api/kb/move-file", {
							source: s.source,
							category: s.category
						});
						if (s.name !== void 0 && s.name !== "" && !s.source.includes(s.name)) {
							const newName = `${s.name}${s.source.slice(s.source.lastIndexOf("."))}`;
							await postJson("/api/kb/rename-file", {
								source: s.source,
								newSource: newName
							});
						}
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							children: importing ? importingLabel : "点击选择文件（可多选）"
						}),
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								...
								children: ["📋 全部文件", files.length > 0 ? `（${files.length}）` : ""]
							})]
						})
					]
				}), viewMode === "files" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					style: card,
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							style: {
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									...
									children: classifying ? "AI 分析中…" : "🤖 AI 整理"
								})
							]
						}),
						suggestions !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							style: {
							...
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									...
									children: "🤖 AI 建议（只建议，不改动；勾选后点\"应用\"）"
								}),
								suggestions.map((s, i) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									style: {
										display: "flex",
										alignItems: "center",
										gap: 8,
									...
									children: [
										...
										s.error !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
											style: {
												color: "#dc2626",
												flex: 1
											},
											...
											/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
												...
												children: [s.name, Array.isArray(s.tags) && s.tags.length > 0 ? ` · #${s.tags.join(" #")}` : ""]
											})
										] })
									]
								}, s.source)),
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							style: { fontSize: 12.5 },
							children: [filteredFiles.length === 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
								style: {
									...sub,
									padding: "8px 0"
								},
								children: "没有符合条件的文件。"
							}), filteredFiles.map((f) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								style: {
									display: "flex",
									alignItems: "center",
									gap: 10,
								...
								children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("select", {
										...
										onChange: (e) => {
											...
											postJson("/api/kb/move-file", {
												source: f.source,
												category: target
											}).then(() => Promise.all([refresh(), loadFiles()])).catch((err) => window.alert(`移动失败：${err instanceof Error ? err.message : String(err)}`));
										},
										children: [categories.includes(f.category) ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
											value: f.category,
											children: f.category
										}), categories.map((c) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
											value: c,
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										...
										children: f.updatedAt.slice(0, 16)
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										style: smallBtn,
										onClick: () => setEditing({
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										...
										onClick: () => void deleteFile(f.source),
										children: "🗑"
									})
								]
							}, f.source))]
