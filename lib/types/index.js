...
import { openKb, upsertEntry, updateEntry, deleteEntry, listEntries, searchKb } from "./kb.js";
...
export function apply(ctx, config) {
    ...
    ctx.tools.register(defineTool({
        name: 'kb_query',
        description: '检索知识库（kb = Knowledge Base，知识库）。按关键词在名称/摘要/内容/标签上匹配，' +
    ...
    ctx.tools.register(defineTool({
        name: 'kb_import',
        description: '导入本机文件到知识库（支持 md/txt/json/yml/docx/pdf）。' +
